    ...
    <section id="home" className="home">
      <div className="home-content container">
        ...
        <p className="description">
          ...
          and gain confidence. Discover a fitness journey built around your lifestyle with personalized workouts,
          powerful mindset coaching, and results that stay. Whether you're just starting out or leveling up,
          we'll help you unlock your best version. Join me and reach your best version — physically and mentally.
        </p>
